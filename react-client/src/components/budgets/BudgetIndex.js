                            ...
                            <form className="range-selector-form" onSubmit={this.handleSubmit}>
                                <fieldset>
                                    <div className="month-year-selector">
                                        ...
                                        <YearSelector keyPrefix="range-start-year" attachRefTo={this.rangeStartDate} startYear={2018} endYear={2018} />
                                    </div>
                                </fieldset>
                                -
                                <fieldset>
                                    <div className="month-year-selector">
                                        ...
                                        <YearSelector keyPrefix="range-end-year" attachRefTo={this.rangeEndDate} startYear={2018} endYear={2018} />
                                    </div>
                                </fieldset>
