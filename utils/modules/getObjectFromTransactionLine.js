module.exports = function getObjectFromTransactionLine (line) {
    ...
    // something's not right with the data if there are fewer items than expected
    ...
    // ignore forecasted transactions since they will usually be duplicated
    // in the posted transactions. this can occur if the export from the bank
    // is run in the very beginning of the subsequent month.
    if (split[0] === 'forecasted') {
        return null
    }
